...
const UserAdd = () => {
   ...
   const handleSubmit = (event) => {
     ...
     console.log(cin);
      ...
      axios.post('http://10.5.100.187:8082/api/v1/user/sa',{
      nom : name,
      prenom : lname,
      cin : cin,
      email :email,
                     ...
                     <Card>
                        <Card.Header className="d-flex justify-content-between">
                           <div className="header-title">
                              <h4 className="card-title">Ajouter Un nouveau Adhérent</h4>
                           </div>
                        </Card.Header>
                        <Card.Body>
                           ...
                           <Form.Group className="form-group">
                              <div className="profile-img-edit position-relative">
                                 <Image className="theme-color-default-img  profile-pic rounded avatar-100" src={avatars4} alt="profile-pic" />
                              </div>
                           </Form.Group>
                           <Form.Group className="form-group">
